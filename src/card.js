...
import criminalLawyers from "./criminal";
import civilLawyers from "./civilRights";
...
export default function Cardila() {
    const classes = useStyles();
    const [i,setI] = React.useState(1);

   
    console.log(civilLawyers);
...
{/* ----------------------------------------------------------------------------------------------------- */}
        ...
        <DialogContent dividers>
          ...
          <img className="column" style={{borderRadius:"50%",width:"200px",height:"200px",marginLeft:"auto",marginRight:"auto",display:"block"}} src="https://cdn.blrankings.com/best-lawyers/lawyer-images/peter-d-anderson-39650?t=2021021118203803" alt="dp"/>
              ...
              <span style={{fontWeight:"bold"}}>Name:</span> <span >{civilLawyers[i].Courseprovider}</span><br/>
              <span style={{fontWeight:"bold"}}>Age:</span> <span >{civilLawyers[i].Age}</span><br/>
              <span style={{fontWeight:"bold"}}>Location:</span> <span >900 Elm Street,<br/> 10th Floor
Manchester, NH 03101</span><br/>
<span style={{fontWeight:"bold"}}>Website:</span> <a href="http://www.mclane.com">{civilLawyers[i].Website}</a><br/>
<span style={{fontWeight:"bold"}}>Contact:</span> <a href="mailto:peter@gmail.com">{civilLawyers[i].Email}</a><br/>
<span style={{fontWeight:"bold"}}>Phone number:</span> <span >(0161) xxx xxxx</span><br/>
 ...
 <Box style={{marginLeft:"auto",marginRight:"auto",textAlign:"center"}} component="fieldset" mb={3} borderColor="transparent">
         <Rating defaultValue={civilLawyers[i].Rating} precision={0.5} name="read-only" readOnly />
  </Box>
  {/* -------------------------------------------------------------------------  */}
      ...
      >
        ...
        <TabPanel value={value} index={1} dir={theme.direction}>
          ...
          <span> {civilLawyers[i].Enrollment}</span>
...
{/* ----------------------------------------------------------------------------------------------------- */}
        ...
        <DialogContent dividers>
          ...
          <img className="column" style={{borderRadius:"50%",width:"200px",height:"200px",marginLeft:"auto",marginRight:"auto",display:"block"}} src="https://cdn.blrankings.com/best-lawyers/lawyer-images/peter-d-anderson-39650?t=2021021118203803" alt="dp"/>
              <div  className="column">
              <span style={{fontWeight:"bold"}}>Name:</span> <span >{environmental[i].Courseprovider}</span><br/>
              <span style={{fontWeight:"bold"}}>Age:</span> <span >{environmental[i].Age}</span><br/>
              <span style={{fontWeight:"bold"}}>Location:</span> <span >900 Elm Street,<br/> 10th Floor
Manchester, NH 03101</span><br/>
<span style={{fontWeight:"bold"}}>Website:</span> <a href="http://www.mclane.com">{environmental[i].Website}</a><br/>
<span style={{fontWeight:"bold"}}>Contact:</span> <a href="mailto:peter@gmail.com">{environmental[i].Email}</a><br/>
<span style={{fontWeight:"bold"}}>Phone number:</span> <span >(0161) xxx xxxx</span><br/>
          <Button variant="contained"  size="small" style={{display:"block",textAlign:"center",marginLeft:'auto',marginRight:"auto",backgroundColor:"#F56464",color:"#fff",marginBottom:"15px"}}>
                                               Environmental Law
                                                {/* {card.Image} */}
          ...
          <div style={{fontWeight:"bold",textAlign:"center"}}>Client Ratings</div>
 <Box style={{marginLeft:"auto",marginRight:"auto",textAlign:"center"}} component="fieldset" mb={3} borderColor="transparent">
         <Rating defaultValue={environmental[i].Rating} precision={0.5} name="read-only" readOnly />
  </Box>
  {/* -------------------------------------------------------------------------  */}
          <div className={classStyle.root}>
      <AppBar position="static" color="default">
      ...
      >
        ...
        <TabPanel value={value} index={1} dir={theme.direction}>
          <div style={{fontWeight:"bold",display:"flex"}}>Total Cases :</div>
          <span> {environmental[i].Enrollment}</span>
...
{/* ----------------------------------------------------------------------------------------------------- */}
        ...
        <DialogContent dividers>
          ...
          <img className="column" style={{borderRadius:"50%",width:"200px",height:"200px",marginLeft:"auto",marginRight:"auto",display:"block"}} src="https://cdn.blrankings.com/best-lawyers/lawyer-images/peter-d-anderson-39650?t=2021021118203803" alt="dp"/>
              <div  className="column">
              <span style={{fontWeight:"bold"}}>Name:</span> <span >{family[i].Courseprovider}</span><br/>
              <span style={{fontWeight:"bold"}}>Age:</span> <span >{family[i].Age}</span><br/>
              <span style={{fontWeight:"bold"}}>Location:</span> <span >900 Elm Street,<br/> 10th Floor
Manchester, NH 03101</span><br/>
<span style={{fontWeight:"bold"}}>Website:</span> <a href="http://www.mclane.com">{family[i].Website}</a><br/>
<span style={{fontWeight:"bold"}}>Contact:</span> <a href="mailto:peter@gmail.com">{family[i].Email}</a><br/>
<span style={{fontWeight:"bold"}}>Phone number:</span> <span >(0161) xxx xxxx</span><br/>
          <Button variant="contained"  size="small" style={{display:"block",textAlign:"center",marginLeft:'auto',marginRight:"auto",backgroundColor:"#F56464",color:"#fff",marginBottom:"15px"}}>
                                               Family Law
                                                {/* {card.Image} */}
          ...
          <div style={{fontWeight:"bold",textAlign:"center"}}>Client Ratings</div>
 <Box style={{marginLeft:"auto",marginRight:"auto",textAlign:"center"}} component="fieldset" mb={3} borderColor="transparent">
         <Rating defaultValue={family[i].Rating} precision={0.5} name="read-only" readOnly />
  </Box>
  {/* -------------------------------------------------------------------------  */}
          <div className={classStyle.root}>
      <AppBar position="static" color="default">
...
{/* ----------------------------------------------------------------------------------------------------- */}
        ...
        <DialogContent dividers>
          ...
          <img className="column" style={{borderRadius:"50%",width:"200px",height:"200px",marginLeft:"auto",marginRight:"auto",display:"block"}} src="https://cdn.blrankings.com/best-lawyers/lawyer-images/peter-d-anderson-39650?t=2021021118203803" alt="dp"/>
              <div  className="column">
              <span style={{fontWeight:"bold"}}>Name:</span> <span >{criminalLawyers[i].Courseprovider}</span><br/>
              <span style={{fontWeight:"bold"}}>Age:</span> <span >{criminalLawyers[i].Age}</span><br/>
              <span style={{fontWeight:"bold"}}>Location:</span> <span >900 Elm Street,<br/> 10th Floor
Manchester, NH 03101</span><br/>
<span style={{fontWeight:"bold"}}>Website:</span> <a href="http://www.mclane.com">{criminalLawyers[i].Website}</a><br/>
<span style={{fontWeight:"bold"}}>Contact:</span> <a href="mailto:peter@gmail.com">{criminalLawyers[i].Email}</a><br/>
<span style={{fontWeight:"bold"}}>Phone number:</span> <span >(0161) xxx xxxx</span><br/>
          <Button variant="contained"  size="small" style={{display:"block",textAlign:"center",marginLeft:'auto',marginRight:"auto",backgroundColor:"#F56464",color:"#fff",marginBottom:"15px"}}>
                                               Criminal Law
                                                {/* {card.Image} */}
          ...
          <div style={{fontWeight:"bold",textAlign:"center"}}>Client Ratings</div>
 <Box style={{marginLeft:"auto",marginRight:"auto",textAlign:"center"}} component="fieldset" mb={3} borderColor="transparent">
         <Rating defaultValue={criminalLawyers[i].Rating} precision={0.5} name="read-only" readOnly />
  </Box>
  {/* -------------------------------------------------------------------------  */}
          <div className={classStyle.root}>
      <AppBar position="static" color="default">
      ...
      >
        ...
        <TabPanel value={value} index={1} dir={theme.direction}>
          <div style={{fontWeight:"bold",display:"flex"}}>Total Cases :</div>
          <span> {criminalLawyers[i].Enrollment}</span>
...
{/* ----------------------------------------------------------------------------------------------------- */}
        ...
        <DialogContent dividers>
          ...
          <img className="column" style={{borderRadius:"50%",width:"200px",height:"200px",marginLeft:"auto",marginRight:"auto",display:"block"}} src="https://cdn.blrankings.com/best-lawyers/lawyer-images/peter-d-anderson-39650?t=2021021118203803" alt="dp"/>
              <div  className="column">
              <span style={{fontWeight:"bold"}}>Name:</span> <span >{bankruptcy[i].Courseprovider}</span><br/>
              <span style={{fontWeight:"bold"}}>Age:</span> <span >{bankruptcy[i].Age}</span><br/>
              <span style={{fontWeight:"bold"}}>Location:</span> <span >900 Elm Street,<br/> 10th Floor
Manchester, NH 03101</span><br/>
<span style={{fontWeight:"bold"}}>Website:</span> <a href="http://www.mclane.com">{bankruptcy[i].Website}</a><br/>
<span style={{fontWeight:"bold"}}>Contact:</span> <a href="mailto:peter@gmail.com">{bankruptcy[i].Email}</a><br/>
<span style={{fontWeight:"bold"}}>Phone number:</span> <span >(0161) xxx xxxx</span><br/>
          <Button variant="contained"  size="small" style={{display:"block",textAlign:"center",marginLeft:'auto',marginRight:"auto",backgroundColor:"#F56464",color:"#fff",marginBottom:"15px"}}>
                                               Bankruptcy Law
                                                {/* {card.Image} */}
          ...
          <div style={{fontWeight:"bold",textAlign:"center"}}>Client Ratings</div>
 <Box style={{marginLeft:"auto",marginRight:"auto",textAlign:"center"}} component="fieldset" mb={3} borderColor="transparent">
         <Rating defaultValue={bankruptcy[i].Rating} precision={0.5} name="read-only" readOnly />
  </Box>
  {/* -------------------------------------------------------------------------  */}
          <div className={classStyle.root}>
      <AppBar position="static" color="default">
      ...
      >
        ...
        <TabPanel value={value} index={1} dir={theme.direction}>
          <div style={{fontWeight:"bold",display:"flex"}}>Total Cases :</div>
          <span> {bankruptcy[i].Enrollment}</span>
